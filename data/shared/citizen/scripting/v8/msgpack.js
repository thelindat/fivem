(function (global, factory) {
	...
	function readExt(length) {
		...
		if (currentExtensions[type]) {
			 ...
			 * try to return a similar data structure to allow custom handling in older scripts to work
			 * not perfect as underlying types and data may be different
			 * i.e. we do not support buffer.buffer.buffer.byteLength...
			 */
			try {
