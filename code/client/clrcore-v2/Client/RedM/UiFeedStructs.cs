...
namespace CitizenFX.RedM
{
	...
	public struct VarString 
	{
		...
		public VarString(int flag, string varStringType, string data)
		{
			m_varStringPtr = Natives.Call<IntPtr>(Hash.VAR_STRING, flag, varStringType, data);
		}
		
		// More testing is needed for these
		// public VarString(int flag, string varStringType, VarString data)
		// {
		// 	m_varStringPtr = Natives.Call<IntPtr>(Hash.VAR_STRING, flag, varStringType, (Int64)data.m_varStringPtr);
		// }
		// 
		// public VarString(int flag, string varStringType, string rgb, VarString data)
		// {
		// 	m_varStringPtr = Natives.Call<IntPtr>(Hash.VAR_STRING, flag, varStringType, rgb, (Int64)data.m_varStringPtr);
		// }
	}
