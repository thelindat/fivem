...
namespace CitizenFX.RedM
{
	public static partial class Inventory
	{
		...
		public static int CreateItemCollection(string filterName, SlotId slotId, ref int size) 
		{
			return Natives.InventoryCreateItemCollection(c_inventoryId, filterName, (uint)slotId, ref size);
		}
