...
namespace CitizenFX.RedM
{
	...
	// [SecuritySafeCritical]
	// internal unsafe struct UnsafeInventoryFilter 
	// {
	// 	[FieldOffset(0x00)] internal int itemHash; // f_0
	// 	
	// 	[FieldOffset(0x08)] internal SlotId slotId; // f_1
	// 	[FieldOffset(0x10)] internal uint fitsSlot; // f_2
	// 	[FieldOffset(0x18)] internal uint hasSlot; // f_3
	// 	
	// 	[FieldOffset(0x20)] internal ItemCategories category; // f_4
	// 	
	// 	[FieldOffset(0x28)] internal fixed byte itemTag[4*8]; // f_5
	// 	
	// 	[FieldOffset(0x50)] internal uint itemGroup; // f_8
	// 	
	// 	[FieldOffset(0x58)] internal UnsafeInventoryGuid parentGuid;
	// 	
	// }
}
